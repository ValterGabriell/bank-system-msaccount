...
public class ExceptionsValues {
    ...
    public static final String CNPJ_INVALID = "CNPJ inválido!";
    ...
    public static final String INVALID_LENGHT = "O valor do ID precisa ter 11 ou 14 digitos!";
    ...
    public static int CNPJ_COUNT = 14;
